...
extern "C" {
	...
	VISP_EXPORT void BlobTracker(unsigned char* const bitmap, int height, int width, int blobCenterX, int blobCenterY, bool isClicked, bool init_done, double cogX, double cogY);
}
